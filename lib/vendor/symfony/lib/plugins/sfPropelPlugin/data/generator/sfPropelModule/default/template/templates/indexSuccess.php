                           ...
                           <div id="title">                               
                            ...
                            <div class="row-actions">
                                <div class="row-actions_[?php echo $i; ?]" style="display: none;">
                                    ...
                                    [?php echo link_to(__('Delete'),'<?php echo $this->getModuleName() ?>/delete?<?php echo $this->getPrimaryKeyUrlParams() ?>, array('method' => 'delete', 'class' => 'delete' , 'confirm' => __('Você tem certeza que deseja excluir esta caracterísitica?'))) ?]
