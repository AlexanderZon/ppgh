...
class qrcode
{
	...
	public function contact_info($name, $address, $phone, $email, $url){
		$this->data = "MECARD:N:".$name.";ADR:".$address.";TEL:".$phone.";EMAIL:".$email.";URL:".$url.";";
	}
	...
	public function get_link($size = 200, $EC_level = 'L', $margin = '0'){
		$this->data = urlencode($this->data); 
