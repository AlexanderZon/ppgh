...
abstract class BaseClientePeer {
	...
	const CLASS_DEFAULT = 'lib.model.geografia.Cliente';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IdCliente', 'NomeCliente', 'Foto', 'Site', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idCliente', 'nomeCliente', 'foto', 'site', ),
		BasePeer::TYPE_COLNAME => array (self::ID_CLIENTE, self::NOME_CLIENTE, self::FOTO, self::SITE, ),
		BasePeer::TYPE_FIELDNAME => array ('id_cliente', 'nome_cliente', 'foto', 'site', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IdCliente' => 0, 'NomeCliente' => 1, 'Foto' => 2, 'Site' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idCliente' => 0, 'nomeCliente' => 1, 'foto' => 2, 'site' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID_CLIENTE => 0, self::NOME_CLIENTE => 1, self::FOTO => 2, self::SITE => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id_cliente' => 0, 'nome_cliente' => 1, 'foto' => 2, 'site' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	{
		$criteria->addSelectColumn(ClientePeer::ID_CLIENTE);
		$criteria->addSelectColumn(ClientePeer::NOME_CLIENTE);
		$criteria->addSelectColumn(ClientePeer::FOTO);
		$criteria->addSelectColumn(ClientePeer::SITE);
	}
    ...
    foreach (sfMixer::getCallables('BaseClientePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseClientePeer', $values, $con))
      {
		...
		if ($criteria->containsKey(ClientePeer::ID_CLIENTE) && $criteria->keyContainsValue(ClientePeer::ID_CLIENTE) ) {
    ...
    foreach (sfMixer::getCallables('BaseClientePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseClientePeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ClientePeer::ID_CLIENTE);
			$selectCriteria->add(ClientePeer::ID_CLIENTE, $criteria->remove(ClientePeer::ID_CLIENTE), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(ClientePeer::ID_CLIENTE, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ClientePeer::ID_CLIENTE, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ClientePeer::DATABASE_NAME);
			$criteria->add(ClientePeer::ID_CLIENTE, $pks, Criteria::IN);
