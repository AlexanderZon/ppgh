...
abstract class BaseCategoria extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the nome_categoria field.
	 * @var        string
	 */
	...
	/**
	 * Get the [nome_categoria] column value.
	 * 
	 * @return     string
	 */
	...
	public function setIdCategoria($v)
	{
		...
		if ($this->id_categoria !== $v) {
			$this->id_categoria = $v;
			$this->modifiedColumns[] = CategoriaPeer::ID_CATEGORIA;
		}
	...
	/**
	 * Set the value of [nome_categoria] column.
	 * 
	...
	public function setNomeCategoria($v)
	{
		...
		if ($this->nome_categoria !== $v) {
			$this->nome_categoria = $v;
			$this->modifiedColumns[] = CategoriaPeer::NOME_CATEGORIA;
		}
	...
	public function setPermalink($v)
	{
		...
		if ($this->permalink !== $v) {
			$this->permalink = $v;
			$this->modifiedColumns[] = CategoriaPeer::PERMALINK;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_categoria = (isset($row[$startcol + 0]) && $row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->nome_categoria = (isset($row[$startcol + 1]) && $row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setIdCategoria($pk);  //[IMV] update autoincrement primary key
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setNomeCategoria($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CategoriaPeer::ID_CATEGORIA)) $criteria->add(CategoriaPeer::ID_CATEGORIA, $this->id_categoria);
		if ($this->isColumnModified(CategoriaPeer::NOME_CATEGORIA)) $criteria->add(CategoriaPeer::NOME_CATEGORIA, $this->nome_categoria);
		if ($this->isColumnModified(CategoriaPeer::PERMALINK)) $criteria->add(CategoriaPeer::PERMALINK, $this->permalink);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CategoriaPeer::ID_CATEGORIA, $this->id_categoria);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setNomeCategoria($this->nome_categoria);
