...
abstract class BaseMateriaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.geografia.Materia';
	...
	/** the column name for the MATERIA field */
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IdMateria', 'Materia', 'Status', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idMateria', 'materia', 'status', ),
		BasePeer::TYPE_COLNAME => array (self::ID_MATERIA, self::MATERIA, self::STATUS, ),
		BasePeer::TYPE_FIELDNAME => array ('id_materia', 'materia', 'status', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IdMateria' => 0, 'Materia' => 1, 'Status' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idMateria' => 0, 'materia' => 1, 'status' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID_MATERIA => 0, self::MATERIA => 1, self::STATUS => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id_materia' => 0, 'materia' => 1, 'status' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		$criteria->addSelectColumn(MateriaPeer::ID_MATERIA);
		$criteria->addSelectColumn(MateriaPeer::MATERIA);
		$criteria->addSelectColumn(MateriaPeer::STATUS);
	}
	 ...
	 *
	 * @param      Materia $value A Materia object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Materia $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = (string) $obj->getIdMateria();
			} // if key === null
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = MateriaPeer::getOMClass(false);
	...
	{
		return $withPrefix ? MateriaPeer::CLASS_DEFAULT : MateriaPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Materia or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseMateriaPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseMateriaPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(MateriaPeer::ID_MATERIA) && $criteria->keyContainsValue(MateriaPeer::ID_MATERIA) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.MateriaPeer::ID_MATERIA.')');
		}
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseMateriaPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseMateriaPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Materia or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseMateriaPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseMateriaPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(MateriaPeer::ID_MATERIA);
			$selectCriteria->add(MateriaPeer::ID_MATERIA, $criteria->remove(MateriaPeer::ID_MATERIA), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseMateriaPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseMateriaPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the materia table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Materia or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(MateriaPeer::ID_MATERIA, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(MateriaPeer::ID_MATERIA, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(MateriaPeer::DATABASE_NAME);
			$criteria->add(MateriaPeer::ID_MATERIA, $pks, Criteria::IN);
