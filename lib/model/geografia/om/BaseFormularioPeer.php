...
abstract class BaseFormularioPeer {
	...
	const CLASS_DEFAULT = 'lib.model.geografia.Formulario';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IdFormulario', 'Nome', 'Conteudo', 'Arquivo', 'Status', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idFormulario', 'nome', 'conteudo', 'arquivo', 'status', ),
		BasePeer::TYPE_COLNAME => array (self::ID_FORMULARIO, self::NOME, self::CONTEUDO, self::ARQUIVO, self::STATUS, ),
		BasePeer::TYPE_FIELDNAME => array ('id_formulario', 'nome', 'conteudo', 'arquivo', 'status', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IdFormulario' => 0, 'Nome' => 1, 'Conteudo' => 2, 'Arquivo' => 3, 'Status' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idFormulario' => 0, 'nome' => 1, 'conteudo' => 2, 'arquivo' => 3, 'status' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID_FORMULARIO => 0, self::NOME => 1, self::CONTEUDO => 2, self::ARQUIVO => 3, self::STATUS => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id_formulario' => 0, 'nome' => 1, 'conteudo' => 2, 'arquivo' => 3, 'status' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	{
		$criteria->addSelectColumn(FormularioPeer::ID_FORMULARIO);
		$criteria->addSelectColumn(FormularioPeer::NOME);
		$criteria->addSelectColumn(FormularioPeer::CONTEUDO);
		$criteria->addSelectColumn(FormularioPeer::ARQUIVO);
		$criteria->addSelectColumn(FormularioPeer::STATUS);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseFormularioPeer', $criteria, $con);
		}
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Formulario) {
				$key = (string) $value->getIdFormulario();
	...
	/**
	 * Method perform an INSERT on the database, given a Formulario or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseFormularioPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseFormularioPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(FormularioPeer::ID_FORMULARIO) && $criteria->keyContainsValue(FormularioPeer::ID_FORMULARIO) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.FormularioPeer::ID_FORMULARIO.')');
		}
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseFormularioPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseFormularioPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Formulario or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseFormularioPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseFormularioPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(FormularioPeer::ID_FORMULARIO);
			$selectCriteria->add(FormularioPeer::ID_FORMULARIO, $criteria->remove(FormularioPeer::ID_FORMULARIO), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseFormularioPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseFormularioPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the formulario table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(FormularioPeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Formulario or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(FormularioPeer::ID_FORMULARIO, (array) $values, Criteria::IN);
	 ...
	 */
	public static function doValidate(Formulario $obj, $cols = null)
	{
		$columns = array();
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(FormularioPeer::ID_FORMULARIO, $pk);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseFormularioPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
