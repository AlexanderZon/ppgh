...
class TipoTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.geografia.map.TipoTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		// columns
		$this->addPrimaryKey('ID_TIPO', 'IdTipo', 'INTEGER', true, 11, null);
		$this->addColumn('NOME_TIPO', 'NomeTipo', 'VARCHAR', true, 20, null);
