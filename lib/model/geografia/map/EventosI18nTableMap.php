...
/**
 * This class defines the structure of the 'eventos_i18n' table.
 *
 *
 ...
 */
class EventosI18nTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.geografia.map.EventosI18nTableMap';
	...
	{
	  // attributes
		$this->setName('eventos_i18n');
		$this->setPhpName('EventosI18n');
		$this->setClassname('EventosI18n');
		...
		$this->addColumn('RESUMEN', 'Resumen', 'LONGVARCHAR', true, null, null);
