...
class MateriaTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.geografia.map.MateriaTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		// columns
		$this->addPrimaryKey('ID_MATERIA', 'IdMateria', 'INTEGER', true, 11, null);
		$this->addColumn('MATERIA', 'Materia', 'VARCHAR', true, 40, null);
