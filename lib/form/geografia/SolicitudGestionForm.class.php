...
/**
 * SolicitudGestion form.
 *
 * @package    Geografia
 * @subpackage form
 * @author     Henry Vallenilla <henryvallenilla@gmail.com>
 */
class SolicitudGestionForm extends BaseSolicitudForm
{
  public function configure()
  {
      ...
      // Widgets
      $this->widgetSchema['id_solicitud_tipo']   = new sfWidgetFormInputHidden();
      ...
      $this->widgetSchema['titulo_trabalho']->setAttributes(array('class' => '','size' => '50','maxlength' => '100'));
      $this->widgetSchema['numero_paginas']->setAttributes(array('class' => '','size' => '30','maxlength' => '30'));
      $this->widgetSchema['titular1']->setAttributes(array('class' => '','size' => '50','maxlength' => '100'));
      $this->widgetSchema['institucion1']->setAttributes(array('class' => '','size' => '50','maxlength' => '100'));
      $this->widgetSchema['endereco1']->setAttributes(array('class' => '','size' => '50','maxlength' => '100'));
      $this->widgetSchema['titular2']->setAttributes(array('class' => '','size' => '50','maxlength' => '100'));
      $this->widgetSchema['institucion2']->setAttributes(array('class' => '','size' => '50','maxlength' => '100'));
      $this->widgetSchema['endereco2']->setAttributes(array('class' => '','size' => '50','maxlength' => '100'));
      ...
      // Valida
      $this->validatorSchema['programa'] = new sfValidatorString(array('required' => true, 'trim' => true));
      ...
      unset($this['status'], $this['programa'], $this['data_realizacao'], $this['horario'], $this['titulo_trabalho'], $this['numero_paginas'], $this['titular1'], $this['institucion1'], $this['endereco1'], $this['titular2'], $this['institucion2'], $this['endereco2']);
