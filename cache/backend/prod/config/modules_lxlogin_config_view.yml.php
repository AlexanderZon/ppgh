...
$response = $this->context->getResponse();
  ...
  $response->addMeta('title', 'DEPARTAMENTO DE GEOGRAFIA - UNIVERSIDADE DE SÃO PAULO', false, false);
  $response->addMeta('language', 'en', false, false);

  $response->addStylesheet('mainLogin.css', '', array ());
