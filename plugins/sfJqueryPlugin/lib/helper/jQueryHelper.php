 ...
 */
sfContext::getInstance()->getResponse()->addJavascript(sfConfig::get('app_sfJQueryPlugin_library_path', 'jq/jquery-1.7.1.min.js'), 'first');
//sfContext::getInstance()->getResponse()->addJavascript(sfConfig::get('app_sfJQueryPlugin_library_path', 'jq/jquery-1.4.2.min.js'), 'first');
...
//Agregados Por Henry 6 Abril 2010
/**
                ...
                $(function(){
                    $.ajax({
                      ...
                      beforeSend: function(objeto){
                            ...
                            $("#$messenger").animate({opacity: 100}, 1500 );

                      },
                      success: function(msg){
                            $("#$messenger").html('$messageSuccess');
                            $("#$messenger").animate({opacity: 0}, 1200 );
                      },
