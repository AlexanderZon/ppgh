...
<?php use_stylesheet('/js/jq/jquery-ui-1.8.16.custom/development-bundle/themes/base/jquery.ui.all.css') ?>       
<?php use_javascript('jq/jquery-ui-1.8.16.custom/js/jquery-1.6.2.min.js') ?>       
<?php use_javascript('jq/jquery-ui-1.8.16.custom/js/jquery-ui-1.8.16.custom.min.js') ?>       
<?php use_javascript('jq/jquery-ui-1.8.16.custom/development-bundle/ui/jquery.ui.core.js') ?>       
<?php use_javascript('jq/jquery-ui-1.8.16.custom/development-bundle/ui/jquery.ui.widget.js') ?>       
<?php use_javascript('jq/jquery-ui-1.8.16.custom/development-bundle/ui/jquery.ui.datepicker.js') ?>       
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#lx_user_id_tipo_usuario").change(function() {
            $.ajax({
              type: "POST",
              url: "loadFormCadastro?type=" + $("#lx_user_id_tipo_usuario").val() ,
              dataType: "script",
              beforeSend: function(objeto){
                    //$("#form-tipo-cadastro").html("Wait ...");
                    $("#preloader").show();
...
<!--                  <tr>
                  ...
                  <tr>
                      <td style="width: 10%;"><?php echo $form['codigo']->renderLabel() ?> <span class="required">*</span></td>
                      <td colspan="5">                          
