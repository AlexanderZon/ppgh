              ...
              <table cellspacing="4">
                <tr>
                    ...
                    <?php if (!$form->getObject()->isNew()): ?>
                        ...
                        <td>
                            <div class="button">
                                <?php echo link_to(__('Eliminar'), 'lxmodule/delete?id_module='.$form->getObject()->getIdModule(), array('method' => 'delete', 'confirm' => __('Você tem certeza que deseja excluir esta caracterísitica?'), 'class' => 'button')) ?>
                            </div>
                        </td>
                        <?php endif; ?>
                    <?php endif; ?>
