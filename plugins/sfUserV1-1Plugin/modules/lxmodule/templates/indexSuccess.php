              ...
              <div class="displayTitle">
                  ...
                  <div class="row-actions" style="width: 180px;">
                      <div class="row-actions_<?php echo $i; ?>" style="display: none;" >
                        ...
                        <?php if($LxModule->getDelete()):?>
                        &nbsp;|&nbsp;
                        <?php echo link_to(__('Delete'),'lxmodule/delete?id_module='.$LxModule->getIdModule(), array('method' => 'delete', 'class' => 'delete' , 'confirm' => __('Você tem certeza que deseja excluir esta caracterísitica?'))) ?>
                        <?php endif;?>
                      </div>
                  </div>
              </div>
