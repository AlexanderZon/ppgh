    ...
    <div style="padding-top: 80px;" align="center">
        <table border="0" cellpadding="0" cellspacing="5">
            ...
            <tbody>
                <tr>
                    <td align="center">
                        <div style="width: 830px; text-align: left; height: 32px; ">
                            <?php echo image_tag('icon_user.gif','align=left') ?>
                            <h1 class="black" style="padding-top: 5px;">Login</h1>
                        </div>
                        <div id="frmLogin">
                        ...
                        <?php endif; ?>
                            <table cellpadding="0" cellspacing="3" border="0" style="margin-top: 20px;margin-bottom: 20px; width: 100%"   >
                                ...
                                <tr align="left">
                                    <td width="45%" align="right"><?php echo $form['login']->renderLabel(__('Usuario')) ?></td>
                                    <td>
