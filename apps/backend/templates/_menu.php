...
<div class="propiedades propiedades-extend" style="width: 115px; border-left: none; height: 80px;">
    <?php echo link_to(image_tag('icons/info_complementaria'),'infocomplementaria/index')  ?><br />
</div>
<div class="propiedades propiedades-extend" style="width: 115px; border-left: none; height: 80px;">
    <?php echo link_to(image_tag('icons/info_vinculo'),'vinculo/index')  ?><br />
</div>
<div class="propiedades propiedades-extend" style="width: 115px; border-left: none; height: 80px;">
    <?php echo link_to(image_tag('icons/info_permisos'),'permisos/index')  ?><br />
</div>