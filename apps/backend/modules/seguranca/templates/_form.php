          ...
          <td>
              <table cellspacing="4">
                <tr>
                    ...
                    <td>
                        <div class="button">
                                                            <?php echo link_to(__('Eliminar'), 'seguranca/delete?id_log='.$form->getObject()->getIdLog(), array('method' => 'delete', 'confirm' => __('Você tem certeza que deseja excluir esta caracterísitica?'), 'class' => 'button')) ?>
                                                    </div>
                    </td>
                    <?php endif; ?>
                    <td>
